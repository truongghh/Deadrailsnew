...
local ToggleButton = Instance.new("ImageButton") -- Dùng ImageButton thay vì TextButton
...
ToggleButton.Image = "rbxassetid://75774010417827" -- << THAY ID logo tại đây
ToggleButton.ScaleType = Enum.ScaleType.Fit -- hoặc Enum.ScaleType.Stretch nếu muốn ảnh phủ hết
...
-- Bật/tắt UI tên "Kenei"
ToggleButton.MouseButton1Click:Connect(function()
	local gui = game.CoreGui:FindFirstChild("Kenei")
	if gui then
...
function library:new(props)
	...
	local outline = utility.new(
		"Frame",
		{
			...
			BorderColor3 = Color3.fromRGB(168, 52, 235),
			BorderSizePixel = 1,
...
function sections:button(props)
	...
	buttonpress.MouseButton1Down:Connect(function()
		...
		wait(0.05)
		outline.BorderColor3 = Color3.fromRGB(168, 52, 235)
...
function keybinds:set(key)
	if key then
		if typeof(key) == "EnumItem" or typeof(key) == "table" then
			...
			if keybind.down then
				keybind.down = false
				keybind.outline.BorderColor3 = Color3.fromRGB(168, 52, 235)
	...
	red[2].FocusLost:Connect(function()
		...
		if num then
			...
			if saved then
				...
				red[3].BorderColor3 = Color3.fromRGB(168, 52, 235)
			else
				red[3].BorderColor3 = Color3.fromRGB(168, 52, 235)
			end
		else
	...
	green[2].FocusLost:Connect(function()
		...
		if num then
			...
			if saved then
				...
				green[3].BorderColor3 = Color3.fromRGB(168, 52, 235)
			else
				green[3].BorderColor3 = Color3.fromRGB(168, 52, 235)
			end
		else
	...
	blue[2].FocusLost:Connect(function()
		...
		if num then
			...
			if saved then
				...
				blue[3].BorderColor3 = Color3.fromRGB(168, 52, 235)
			else
				blue[3].BorderColor3 = Color3.fromRGB(168, 52, 235)
			end
		else
		...
		if #saved >= 6 and #saved <= 7 then
			...
			if e == true then
				...
				if hexcolor then
					...
					hex[2].Text = ""
					hex[3].BorderColor3 = Color3.fromRGB(168, 52, 235)
				else
					hex[2].Text = ""
					hex[3].BorderColor3 = Color3.fromRGB(168, 52, 235)
				end
...
function sections:configloader(props)
	...
	name[2].FocusLost:Connect(function()
		...
		name[3].BorderColor3 = Color3.fromRGB(168, 52, 235)
	end)
	--
	load[3].MouseButton1Down:Connect(function()
		...
		wait(0.05)
		load[2].BorderColor3 = Color3.fromRGB(168, 52, 235)
	end)
	--
	delete[3].MouseButton1Down:Connect(function()
		...
		wait(0.05)
		delete[2].BorderColor3 = Color3.fromRGB(168, 52, 235)
		wait()
		refresh()
	end)
	--
	save[3].MouseButton1Down:Connect(function()
		...
		wait(0.05)
		save[2].BorderColor3 = Color3.fromRGB(168, 52, 235)
		wait()
		refresh()
	end)
	--
	create[3].MouseButton1Down:Connect(function()
		...
		wait(0.05)
		create[2].BorderColor3 = Color3.fromRGB(168, 52, 235)
		wait()
		refresh()
	end)
	-- // button tbl
...
local window = library:new({textsize = 13.5,font = Enum.Font.RobotoMono,name = "Truong Depzai | discord.gg/AkDgH65MUF",color = Color3.fromRGB(255,255,255)})

local Tab1 = window:page({name = " Update sau"})
local Tab2 = window:page({name = "Main"})
local Tab3 = window:page({name = "Update sau"})
local Tab4 = window:page({name = "Update sau"})
